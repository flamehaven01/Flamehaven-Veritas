...
def build_pdf_styles() -> dict:
    ...
    return {
        ...
        "doc_sub": _s(
            "DocSub", "Normal", fontSize=9, spaceAfter=0, textColor=colors.HexColor("#a8b2d8")
        ),
        "sec_hdr": _s(
            "SecHdr",
            "Normal",
        ...
        "body": _s("Body", "Normal", fontSize=9, leading=13, spaceAfter=4, textColor=C["text"]),
        "cover_key": _s(
            "CvrKey",
            "Normal",
            fontSize=8.5,
        ...
        "cover_val": _s("CvrVal", "Normal", fontSize=8.5, leading=11, textColor=C["text"]),
        "tbl_hdr": _s(
            "TblHdr",
            "Normal",
            fontSize=8,
        ...
        "tbl_cell": _s("TblCell", "Normal", fontSize=8, leading=10, textColor=C["text"]),
        "finding": _s("Finding", "Normal", fontSize=8, leading=11, textColor=C["text"]),
        "meta": _s("Meta", "Normal", fontSize=7, textColor=C["subtext"]),
    }
