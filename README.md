...
flowchart TD
    ...
    I --> J[LOGOS IRF-Calc 6D\nReasoning Quality]
    I --> K[HSTA 4D\nBibliometric Score]
    I --> L[BibliographyAnalyzer\nReference Stats]
    I --> M[ReproducibilityChecklist\n8-criterion ARRIVE/CONSORT]

    J & K & L & M --> N[Omega Score\n0.0 – 1.0]
