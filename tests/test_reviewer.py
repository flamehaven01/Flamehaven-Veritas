...
class TestPersonaConfig:
    def test_presets_defined(self):
        from veritas.reviewer.persona import STRICT, BALANCED, LENIENT
    ...
    def test_strict_weights_elevated(self):
        from veritas.reviewer.persona import STRICT, BALANCED
    ...
    def test_lenient_weights_reduced(self):
        from veritas.reviewer.persona import LENIENT, BALANCED
    ...
    def test_calibrate_omega_strict_penalises_low_maf(self):
        ...
        from veritas.reviewer.persona import STRICT, BALANCED, calibrate_omega
        from veritas.types import IRF6DScores
...
class TestDR3Protocol:
    def _make_consensus(self, omega, reached=True, spread=0.10):
        ...
        return ConsensusResult(
            omegas={}, consensus_omega=omega, variance=0.0,
            spread=spread, reached=reached, recommendation="ACCEPT",
        )
    ...
    def test_penalty_applied(self):
        from veritas.reviewer.dr3 import DR3Protocol, DR3_PENALTY_FACTOR
        dr3 = DR3Protocol()
        c = self._make_consensus(0.45, reached=False)
    ...
    def test_no_trigger_exact_threshold(self):
        from veritas.reviewer.dr3 import DR3Protocol, DR3_TRIGGER_THRESHOLD
        dr3 = DR3Protocol()
...
class TestReviewerPackageExports:
    def test_all_symbols_importable(self):
        from veritas.reviewer import (
            PersonaConfig, calibrate_omega, STRICT, BALANCED, LENIENT,
            ConsensusResult, CrossValidator, check_consensus,
            DR3Protocol, DR3Resolution,
            PersonaReview, ReviewSimEngine, ReviewSimResult,
        )
